...
class CompetitionEditingFormFactory2 extends OwlcmsCrudFormFactory<Competition> {
    Logger logger = (Logger) LoggerFactory.getLogger(CompetitionEditingFormFactory2.class);

    CompetitionEditingFormFactory2(Class<Competition> domainType) {
        super(domainType);
    }
